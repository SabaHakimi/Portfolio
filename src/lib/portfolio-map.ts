    ...
    subsections: [
      {
        id: "current-role",
        label: "Current role",
        summary: "Placeholder for the most recent position and its impact.",
      },
      {
        id: "prior-role",
        label: "Prior role",
        summary: "Placeholder for a previous position and core contributions.",
      },
      {
        id: "leadership",
        label: "Leadership",
        summary: "Placeholder for mentorship, ownership, and collaboration.",
      },
    ],
  },
  {
    ...
    subsections: [
      {
        id: "project-alpha",
        label: "Project Alpha",
        summary: "Placeholder for a flagship project case study.",
      },
      {
        id: "project-beta",
        label: "Project Beta",
        summary: "Placeholder for a second technical project.",
      },
      {
        id: "experiments",
        label: "Experiments",
        summary: "Placeholder for prototypes and smaller explorations.",
      },
    ],
  },
  {
